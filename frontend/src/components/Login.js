  ...
  return (
    <div>
      ...
      <div className='absolute'>
        <img className='w-[100vw]  h-[100vh] bg-cover' src="https://singh-cp.github.io/netflix-landingpage/images/netflix-background-image.jpg" alt='banner' />
      </div>
      <form onSubmit={getInputData} className='flex flex-col w-3/12  p-12 my-36 left-0 right-0 items-center justify-center mx-auto absolute rounded-md bg-black opacity-90'>
      <h1 className='text-3xl text-white mb-5 font-semibold'>{isLogin ? "Login" : "Signup"}</h1>
